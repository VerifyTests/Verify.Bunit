...
public static class VerifyBunit
{
    ...
    /// the <paramref name="component" /> renders.
    /// </summary>
    /// <param name="component">The rendered component to attempt to verify state against.</param>
    ...
    public static void WaitFor<TComponent>(this IRenderedComponent<TComponent> component, Func<bool> predicate, TimeSpan? timeout = null)
        where TComponent : IComponent =>
        component.WaitForState(predicate, timeout);

    public static void ClickAsync(
    ...
    public static void ChangeAsync<T>(this IElement element, T value) =>
        element.Change(CreateFrom(value));
